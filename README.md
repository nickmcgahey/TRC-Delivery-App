...
Greenfield repository. **Architecture: Hybrid (chosen)** — CanFleet for drivers/dispatch/POD; this repo for customer PWA/mobile, compliance/pricing gateway, and later admin polish. **Payments: BlazePay.** Commerce SoR remains WordPress + WooCommerce + Breadstack.
